...
-------------------------------------------------------------------------------
   ...
   Version 0.4 -- July 21, 2016 -- Marc Costa Sitja, ESAC/ESA

      Updated the Jupiter generic frame definitions and format.

      Corrected errors in the JUICE_JUPITER_IF_J2000 and 
      JUICE_JUPITER_DM definitions.
...
------------------------------------------------------------------------
   ...
   defined to be titled 9.50 degrees away from the Jovian spin axis
...
------------------------------------------------------------------------
   ...
   JUICE_JUPITER_MAG_SIII body-fixed frame, which provides the 
   orientation for the Jupiter North magnetic dipole and the Jupiter 
   magnetic frame with respect to the IAU_JUPITER frame.   
   ...
   JUICE_JUPITER_MAG_SIII frame. Different implementations of this 
   frame, i.e. changes to the existing frame definition will lead to 
   different orientations of the North geomagnetic centered dipole, but 
   only when these data lead to different right ascension and declination
...
------------------------------------------------------------------------
   ...
   The primary vector of this frame is defined based on the 
   JUICE_JUPITER_MAG_SIII frame. Different implementations of this frame, 
   i.e. changes to the existing frame definition will lead to different
  ...
  \begindata
      ...
      FRAME_-28992_PRI_FRAME        = 'JUICE_JUPITER_MAG_SIII'
...
------------------------------------------------------------------------
  ...
  file containing the orientation constants for Jupiter must be
  loaded before using this frame.

  The secondary vector is defined in the J2000 frame and therefore
  it does not require any additional data.
...
------------------------------------------------------------------------
  ...
  It is strongly recommended to indicate what data have been used
  in the evaluation of this frame when referring to it, i.e.
  JUPITER_SUN_EQU using the IAU 2009 constants and DE ephemerides.
...
------------------------------------------------------------------------
  ...
  The primary vector is defined as an 'observer-target position'
  vector. Therefore, the ephemeris data required to compute the
  Jupiter-Sun vector in the J2000 reference frame must
  be loaded before using this frame.

  The secondary vector is defined as an 'observer-target velocity'
  vector. Therefore, the ephemeris data required to compute the
  Jupiter-Sun velocity vector in the J2000 reference frame
  must be loaded before using this frame.
...
------------------------------------------------------------------------
  ...
  The secondary vector is defined as an 'observer-target position'
  vector. Therefore, the ephemeris data required to compute the
  Jupiter-Callisto vector in the J2000 frame must be loaded
  before using this frame.
  ...
  It is strongly recommended to indicate what data have been used
  in the evaluation of this frame when referring to it, e.g.
  JUPITER_CALLISTO_BCSF using the DE405 ephemerides.
...
JJupiter-Centric Europa-Following Frame (JUPITER_EUROPA_BCSF)
------------------------------------------------------------------------
  ...
  The secondary vector is defined as an 'observer-target position'
  vector. Therefore, the ephemeris data required to compute the
  Jupiter-Europa vector in the J2000 frame must be loaded
  before using this frame.
  ...
  It is strongly recommended to indicate what data have been used
  in the evaluation of this frame when referring to it, e.g.
  JUPITER_EUROPA_BCSF using the DE405 ephemerides.
...
------------------------------------------------------------------------
  ...
  The secondary vector is defined as an 'observer-target position'
  vector. Therefore, the ephemeris data required to compute the
  Jupiter-Ganymede vector in the J2000 frame must be loaded
  before using this frame.
  ...
  It is strongly recommended to indicate what data have been used
  in the evaluation of this frame when referring to it, e.g.
  JUPITER_GANYMEDE_BCSF using the DE405 ephemerides.
...
------------------------------------------------------------------------
  ...
  The primary vector is defined as an 'observer-target position'
  vector. Therefore, the ephemeris data required to compute the
  Callisto-Jupiter vector in the J2000 reference frame must
  be loaded before using this frame.
...
------------------------------------------------------------------------
  ...
  The primary vector is defined as an 'observer-target position'
  vector. Therefore, the ephemeris data required to compute the
  Europa-Jupiter vector in the J2000 reference frame must
  be loaded before using this frame.
...
------------------------------------------------------------------------
  ...
  The primary vector is defined as an 'observer-target position'
  vector. Therefore, the ephemeris data required to compute the
  Ganymede-Jupiter vector in the J2000 reference frame must
  be loaded before using this frame.
